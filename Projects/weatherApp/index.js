...
let currentTab = userTab; // oldTab == currentTab
...
function switchTab(clickedTab) {
    if(clickedTab != currentTab) {
        ...
        if(!searchForm.classList.contains("active")) {
            ...
            // maine phele search wala tab pr tha, ab your weather tab visible karna hai
...
function renderWeatherInfo(weatherInfo) {
    ...
    //for testing of getting weather info
...
function getLocation() {
    if(navigator.geolocation) {
        ...
        // H/W - show an aert for no geolocation support available
    }
}
