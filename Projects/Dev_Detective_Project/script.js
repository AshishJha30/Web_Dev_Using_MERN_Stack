...
function init() {
    ...
    if(value === null) {
        console.log("null m hai");
        localStorage.setItem("dark-mode", darkMode);
        lightModeProperties();
    }
    else if(value == "true") {
        console.log("true m hai");
        darkModeProperties();
    }
    else if(value == "false") {
        console.log("false m hai");
        lightModeProperties();
    }

    // by default, ek Id show hogi abhi pranay ki hai change karna hai
    getUserData(url + "ashishjha30");
}
